...
public class GuiCustomizeWorldScreenRTG extends GuiScreen implements GuiSlider.FormatHelper, GuiPageButtonList.GuiResponder {
    ...
    private ChunkProviderSettingsRTG.Factory defaultSettings = new ChunkProviderSettingsRTG.Factory();
    private ChunkProviderSettingsRTG.Factory settings;
    ...
    public void loadValues(String p_175324_1_) {
        if (p_175324_1_ != null && !p_175324_1_.isEmpty()) {
            this.settings = ChunkProviderSettingsRTG.Factory.jsonToFactory(p_175324_1_);
        } else {
            this.settings = new ChunkProviderSettingsRTG.Factory();
        }
    }
